...
def detect_rectangle_from_camera(camera_index=1):
    ...
    while True:
        ...
        for idx, (box, width_cm, height_cm, angle, center, rect, area) in enumerate(rectangles, 1):
            ...
            # Distance from left edge to rectangle's leftmost point
            ...
            if key in [ord('y'), ord('Y')]:
                ...
                return rect_data  # Return the detected rectangle data
            else:
    ...
    cap.release()
    cv2.destroyAllWindows()
    return None  # No rectangle detected or user exited